...
export default async function Dash() {
    ...
    return (
    <div className="md:container mx-auto text-sky-700 dark:text-gray-600 rounded rounded-xl" >
        <section className="py-8  px-6">
            <div className="container mx-auto">
                <h1 className="text-4xl md:text-5xl font-semibold border-b border-blue-800 text-white dark-text-gray-500 dark:border-white pb-12">
                    Top Gambling slots
                </h1>
            </div>
        </section>
        ...
        <section className="py-8  px-6">
            <div className="container mx-auto">
                <h1 className="text-4xl md:text-5xl font-semibold border-b border-blue-800 text-white dark:border-gray-500 pb-12">
                    Top 15 Casino List
                </h1>
            </div>
        </section>
