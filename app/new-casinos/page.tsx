...
export async function generateMetadata({ params }): Promise<Metadata> {
    const Title = 'New Online Casinos : ' + monthYear() + ' New Casinos on Allfreechips'
    const Description = 'See the latest online casinos here as we add every new casino in order, new ' + monthYear() + ' online casinos'
    return {
      title: Title,
...
export default async function PageOut ({params}) {
  ...
  const links = [
    ...
    { link: "#Review", text: `Abount New Casinos` },
