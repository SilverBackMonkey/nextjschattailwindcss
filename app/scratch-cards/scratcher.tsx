      ...
      <form action={play}>
        <div className="md:w-90 m-2 flex">
          ...
          <div className="flex-1">
            ...
            <div
              className="text-center p-2 w-96"
              style={{ backgroundImage: 'url("/background/scratch_bg.png")' }}
            >
              <section
                className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 justify-items-center items-center gap-y-8 gap-x-10 mt-4 mb-4"
                style={{ height: "310px" }}
              >
                {Array(9)
                  .fill(null)
          ...
          <div className="flex-1">
            <h1 className="font-bold text-md">Add New Text</h1>
          </div>
        </div>
